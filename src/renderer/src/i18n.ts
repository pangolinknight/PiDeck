...
const zhCN = {
  ...
  "config.developerRoleDesc": "关闭后使用 system role 发送系统提示。部分第三方 API 不支持 developer role。",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "config.reasoningEffortDesc": "关闭后不发送 reasoning_effort 参数。部分兼容 API 会因不识此参数而报错。",
  "config.inputType": "输入",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "config.developerRoleDesc": "When disabled, sends system prompts using the system role instead of developer role. Some third-party APIs do not support the developer role.",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "config.reasoningEffortDesc": "When disabled, omits the reasoning_effort parameter. Some compatible APIs reject this parameter.",
